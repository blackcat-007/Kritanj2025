...
const EventDetailPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#0D0E13] text-white p-0">
          <Navbar />
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-6">
                    {eventDetails.contestname && (
                        <h1 className="text-3xl glowing-text font-bold">{eventDetails.contestname}</h1>
                    )}
                    <img 
                        src={eventDetails.poster} 
                        alt="Event Poster" 
                    ...
                    <div className="space-y-3">
                        ...
                        {eventDetails.prizeMoney && <p className="text-gray-300">🏆 Prize Money: {eventDetails.prizeMoney}</p>}
